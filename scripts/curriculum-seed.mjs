...
const seedTopicCanonicalIds = {
  ...
  integers: ['NUM.04'],
  'ratio-proportion-percentage': ['NUM.08', 'NUM.09'],
  ...
  'descriptive-statistics': ['DAT.01', 'DAT.02'],
  'math-finance': ['NUM.09'],
  polynomials: ['ALG.07'],
};

const seedLessonCanonicalIds = {
  'natural-numbers-reading': canonicalRange('NUM.01', 1, 7),
  'natural-numbers-operations': canonicalRange('NUM.02', 1, 10),
  'natural-numbers-divisibility': canonicalRange('NUM.03', 1, 6),
  'fractions-intro': canonicalRange('NUM.06', 1, 8),
  'fractions-operations': canonicalRange('NUM.06', 12, 18),
  'fractions-equivalence': canonicalRange('NUM.06', 9, 12),
  'fractions-review': ['NUM.06.19', 'NUM.06.20'],
  'decimal-reading': canonicalRange('NUM.07', 1, 4),
  'decimal-operations': ['NUM.07.05', 'NUM.07.06', 'NUM.07.08'],
  'decimal-fractions': ['NUM.07.07', 'NUM.07.09'],
  'geometry-perimeter': ['GEO.03.01', 'GEO.03.03', 'GEO.03.08', 'GEO.08.05'],
  'geometry-triangles': ['GEO.04.01', 'GEO.04.02', 'GEO.04.03', 'GEO.04.04', 'GEO.08.08'],
  'geometry-units': ['GEO.08.01', 'GEO.08.02', 'GEO.08.03', 'GEO.08.04', 'GEO.08.15', 'GEO.08.16', 'GEO.08.17', 'GEO.08.18'],
  'algebra-variables': ['ALG.01.01', 'ALG.01.04', 'ALG.01.05', 'ALG.01.07'],
  'algebra-like-terms': ['ALG.01.02', 'ALG.01.03', 'ALG.01.06'],
  'algebra-patterns': ['ALG.01.08'],
  'angles-measure': ['GEO.02.01', 'GEO.02.02', 'GEO.02.03', 'GEO.02.04'],
  'polygons-properties': ['GEO.03.01', 'GEO.03.02', 'GEO.03.03', 'GEO.03.06', 'GEO.03.08'],
  'triangles-angles': ['GEO.02.05', 'GEO.02.06', 'GEO.03.04', 'GEO.03.05'],
  'integers-meaning': ['NUM.04.01', 'NUM.04.02', 'NUM.04.03'],
  'integers-operations': ['NUM.04.04', 'NUM.04.05', 'NUM.04.06'],
  'integers-problems': ['NUM.04.07'],
  'ratio-concept': ['NUM.08.01', 'NUM.08.02', 'NUM.08.10', 'NUM.08.11'],
  'proportion-rule': ['NUM.08.03', 'NUM.08.04', 'NUM.08.05', 'NUM.08.06', 'NUM.08.07', 'NUM.08.08', 'NUM.08.09'],
  'percentage-intro': ['NUM.09.01', 'NUM.09.02', 'NUM.09.03', 'NUM.09.04', 'NUM.09.05'],
  'linear-intro': ['ALG.04.01', 'ALG.04.02', 'ALG.04.03'],
  'linear-problems': ['ALG.04.04'],
  'linear-equations-forms': ['ALG.04.02', 'ALG.04.03'],
  'systems-intro': ['ALG.05.01', 'ALG.05.05', 'ALG.05.06'],
  'systems-substitution': ['ALG.05.02'],
  'systems-problems': ['ALG.05.07'],
  'powers-exponents': canonicalRange('NUM.10', 1, 9),
  'roots-square': ['NUM.11.01', 'NUM.11.02', 'NUM.11.03', 'NUM.11.04', 'NUM.11.05'],
  'scientific-notation': ['NUM.10.09', 'NUM.10.10', 'NUM.10.11', 'NUM.10.12'],
  'powers-chapter-review': canonicalRange('NUM.10', 1, 12),
  'roots-chapter-review': ['NUM.11.01', 'NUM.11.02', 'NUM.11.03', 'NUM.11.04', 'NUM.11.05', 'NUM.11.07', 'NUM.11.08'],
  'stats-tables': canonicalRange('DAT.01', 1, 9),
  'stats-average': ['DAT.02.01', 'DAT.02.02', 'DAT.02.03', 'DAT.02.04', 'DAT.02.05', 'DAT.02.06', 'DAT.02.07', 'DAT.02.10'],
  'probability-basics': ['DAT.04.01', 'DAT.04.02', 'DAT.04.03', 'DAT.04.04', 'DAT.04.05', 'DAT.04.06', 'DAT.04.09'],
  'functions-intro': ['FUN.01.01', 'FUN.01.02', 'FUN.01.03'],
  'functions-graphs': ['FUN.01.04', 'FUN.01.05', 'FUN.01.06', 'FUN.01.07', 'FUN.01.08'],
  'functions-cartesian': ['FUN.01.04'],
  'similarity-concept': ['GEO.04.06', 'GEO.04.11'],
  'pythagoras-theorem': ['GEO.04.14'],
  'metric-relations': ['GEO.04.13', 'GEO.04.15'],
  'quadratic-intro': ['ALG.06.01', 'ALG.06.04', 'ALG.06.05'],
  'quadratic-factoring': ['ALG.06.02'],
  'quadratic-bhaskara': ['ALG.06.03', 'ALG.06.06', 'ALG.06.07'],
  'spatial-solids': ['GEO.10.01', 'GEO.10.03', 'GEO.10.04', 'GEO.10.05', 'GEO.10.07', 'GEO.10.08', 'GEO.10.10', 'GEO.10.15'],
  'spatial-volume': ['GEO.10.12'],
  'spatial-area': ['GEO.10.11'],
  'counting-principle': ['DAT.03.01', 'DAT.03.02', 'DAT.03.03'],
  'combinatorics-arrangements': ['DAT.03.04', 'DAT.03.05', 'DAT.03.06', 'DAT.03.07'],
  'probability-combinatorics': ['DAT.04.01', 'DAT.04.02', 'DAT.04.03', 'DAT.04.04', 'DAT.04.05', 'DAT.04.06', 'DAT.04.09'],
  'affine-concept': ['FUN.02.01', 'FUN.02.02', 'FUN.02.06'],
  'affine-graph': ['FUN.02.03', 'FUN.02.04', 'FUN.02.05'],
  'affine-problems': ['FUN.02.07'],
  'quadratic-function-concept': ['FUN.03.01', 'FUN.03.02', 'FUN.03.03'],
  'quadratic-function-zeros': ['FUN.03.07', 'FUN.03.08'],
  'quadratic-function-vertex': ['FUN.03.04', 'FUN.03.05', 'FUN.03.06', 'FUN.03.09'],
  'trigonometry-intro': ['TRI.01.01', 'TRI.01.02'],
  'trigonometry-angles': ['TRI.01.03'],
  'trigonometry-applications': ['TRI.01.04', 'TRI.01.05', 'TRI.01.06', 'TRI.01.07'],
  'analytic-points': ['AGE.01.01', 'AGE.01.02', 'AGE.01.03', 'AGE.01.04', 'AGE.01.05'],
  'analytic-line': ['AGE.02.01', 'AGE.02.02', 'AGE.02.03'],
  'analytic-parallelism': ['AGE.02.04', 'AGE.02.05', 'AGE.02.06', 'AGE.02.07'],
  'exponential-function': ['FUN.05.01', 'FUN.05.02', 'FUN.05.03', 'FUN.05.04', 'FUN.05.05', 'FUN.05.06'],
  'logarithm-concept': ['FUN.05.07', 'FUN.05.08', 'FUN.05.09', 'FUN.05.10', 'FUN.05.11', 'FUN.05.12', 'FUN.05.13'],
  'exp-log-applications': ['FUN.05.02', 'FUN.05.03', 'FUN.05.04', 'FUN.05.09', 'FUN.05.10'],
  'matrices-intro': ['ALG.09.01', 'ALG.09.02', 'ALG.09.03', 'ALG.09.04', 'ALG.09.05', 'ALG.09.06'],
  'determinants-intro': ['ALG.09.07', 'ALG.09.08'],
  'matrices-systems-solving': ['ALG.09.09', 'ALG.09.10'],
  'progressions-patterns': ['ALG.10.01', 'ALG.10.02'],
  'arithmetic-progression': ['ALG.10.03', 'ALG.10.04', 'ALG.10.05'],
  'geometric-progression': ['ALG.10.06', 'ALG.10.07', 'ALG.10.08', 'ALG.10.09'],
  'complex-unit': ['NUM.12.01', 'NUM.12.02', 'NUM.12.05'],
  'complex-operations': ['NUM.12.03', 'NUM.12.04'],
  'complex-equations': ['NUM.12.06', 'NUM.12.07', 'NUM.12.08', 'NUM.12.09', 'NUM.12.10'],
  'descriptive-graphics': canonicalRange('DAT.01', 1, 10),
  'descriptive-dispersion': ['DAT.02.01', 'DAT.02.02', 'DAT.02.07', 'DAT.02.08', 'DAT.02.09', 'DAT.02.10'],
  'descriptive-decision': ['DAT.02.03', 'DAT.02.04', 'DAT.02.05', 'DAT.02.06', 'DAT.02.10'],
  'finance-review': ['NUM.09.01', 'NUM.09.02', 'NUM.09.03', 'NUM.09.04', 'NUM.09.05'],
  'simple-interest': ['NUM.09.06', 'NUM.09.08', 'NUM.09.09'],
  'compound-interest': ['NUM.09.07', 'NUM.09.08', 'NUM.09.10'],
  'polynomials-operations': ['ALG.07.01', 'ALG.07.02', 'ALG.07.03', 'ALG.07.04'],
  'polynomials-factorization': ['ALG.07.09', 'ALG.07.10'],
  'polynomials-division': ['ALG.07.05', 'ALG.07.06', 'ALG.07.07', 'ALG.07.08'],
};
...
const lesson = (
  ...
  tags,
  status,
  canonicalIds: seedLessonCanonicalIds[id] ?? [],
  body,
});
...
const topic = (
  ...
  order,
  tags,
  canonicalIds: seedTopicCanonicalIds[id] ?? [],
  overview,
  lessons,
});
