...
export function AppFooter({ onOpenCatalog, onOpenHomeSection, onOpenRoadmap, onStartRecommendedFlow }: AppFooterProps) {
  return (
      ...
      <div className="mx-auto grid max-w-7xl grid-cols-1 gap-12 px-6 md:grid-cols-4">
        ...
        <div>
          ...
          <ul className="flex flex-col gap-2 text-xs font-bold uppercase">
            <li>
              <button onClick={onOpenCatalog} className="hover:underline">
                Cursos
              </button>
            </li>
            <li>
              <button onClick={onOpenRoadmap} className="hover:underline">
                Roadmap
              </button>
            </li>
            <li>
