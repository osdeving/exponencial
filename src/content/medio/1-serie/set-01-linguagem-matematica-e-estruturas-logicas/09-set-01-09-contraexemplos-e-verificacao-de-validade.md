...
canonicalIds:
  - SET.01.09
---
# contraexemplos e verificação de validade

> Estrutura pronta para conteúdo. Substitua este texto pelo tutorial completo em Markdown.

## Resumo da aula

Estrutura inicial para o item canônico SET.01.09. Substitua este placeholder pela teoria definitiva em Markdown.
