...
canonicalIds:
  - SET.03.04
---
# representações por conjunto, tabela, diagrama e gráfico

> Estrutura pronta para conteúdo. Substitua este texto pelo tutorial completo em Markdown.

## Resumo da aula

Estrutura inicial para o item canônico SET.03.04. Substitua este placeholder pela teoria definitiva em Markdown.
