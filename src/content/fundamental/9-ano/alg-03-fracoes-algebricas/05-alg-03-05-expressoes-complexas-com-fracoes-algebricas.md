...
canonicalIds:
  - ALG.03.05
---
# expressões complexas com frações algébricas

> Estrutura pronta para conteúdo. Substitua este texto pelo tutorial completo em Markdown.

## Resumo da aula

Estrutura inicial para o item canônico ALG.03.05. Substitua este placeholder pela teoria definitiva em Markdown.
